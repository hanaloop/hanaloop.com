...
description: >-
  EU CSDDD는 대기업 및 수출 기업에 공급망 전반의 ESG 리스크 실사 및 시정 조치를 의무화하는 제도로, 비EU 기업에도 영향을 미치는
  글로벌 규제입니다. CSDDD의 주요 일정과 적용 대상, 실사 범위 및 기업 실무자 대응 전략까지 한눈에 파악할 수 있는 가이드 글입니다.
payloadGenerated: true
---
import CaptionedImage from "../../../src/components/theme/CaptionedImage";

<CaptionedImage imageSrc="/images/docs/2025/20250708-CSDDD.png" caption="CSDDD" containerClassName="w-[500px]" imageClassName="shadow-md border-8 border-gray-100"/>
